...
# setattrs!(f, "description", "This is a mock experiment with voltage values over time")
...
# dset_time_1 = create_dataset(grp_1, "time"; data=time)
# setattrs!(dset_time_1, "unit", "ms")

# dset_voltage_1 = create_dataset(grp_1, "voltage"; data=voltage_1)
# setattrs!(dset_voltage_1, "unit", "mV")

dset_time_1, _ = create_dataset(grp_1, "time"; data=time)
write(dset_time_1, time)
attributes(dset_time_1)["unit"] = "ms"

dset_voltage_1, _ = create_dataset(grp_1, "voltage"; data=voltage_1)
...
dset_time_2, _ = create_dataset(grp_2, "time"; data=time)
write(dset_time_2, time)
attributes(dset_time_2)["unit"] = "ms"

dset_voltage_2, _ = create_dataset(grp_2, "voltage"; data=voltage_2)
...
dset_time_4, _ = create_dataset(grp_4, "time"; data=time)
